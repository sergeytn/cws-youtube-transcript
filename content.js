...
const headerDiv = (box) => {
    ...
    //LOGO Creation
    let logoImgSrc = chrome.runtime.getURL("assests/logo.svg")
    ...
    title.innerText = "Youtube Video Summarizer"
    title.setAttribute('id', "titleId")
    titleDiv.appendChild(title)

    //DropDown Creation
    let vectorImgSrc = chrome.runtime.getURL("assests/Vector.svg")
...
const createNoTranscript = () => {
    if (!document.getElementById("noTranscriptDiv")) {
        ...
        let notranscriptImgSrc = chrome.runtime.getURL("assests/notranscript.svg")
...
const transcriptBtnListener = () => {
    ...
    transcriptBtnDiv.style.background = "#FC7D00"
    transcriptBtnDiv.style.color = "#FFFFFF"
    summaryBtnDiv.style.background = "#FFFFFF"
    summaryBtnDiv.style.color = "#45413F"
}
...
const summaryBtnListener = () => {
    ...
    summaryBtnDiv.style.background = "#FC7D00"
    summaryBtnDiv.style.color = "#FFFFFF"
    transcriptBtnDiv.style.background = "#FFFFFF"
    transcriptBtnDiv.style.color = "#45413F"
    ...
    if (accessTokenValidity) {
            ...
            chrome.runtime.onMessage.addListener(function (response, sender, sendResponse) {
                ...
                if (response.message === 'answer') {
                    ...
                    if (!document.querySelector("#footerDiv")) {
                        ...
                        ratingDiv.href="https://chrome.google.com/#"
                        ratingDiv.target="_blank"

                        let starSrc = chrome.runtime.getURL("assests/star.svg")
                        ...
                        let copyIconSrc = chrome.runtime.getURL("assests/copyIcon.svg")
        ...
        if (!document.getElementById("loginDiv")) {
            ...
            let infoSrc = chrome.runtime.getURL("assests/info.svg")
            let info = new Image()
